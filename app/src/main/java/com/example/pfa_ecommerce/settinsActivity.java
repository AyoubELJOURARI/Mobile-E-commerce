...
public class settinsActivity extends AppCompatActivity {
    ...
    private StorageReference StorageProfilPictureRef;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StorageProfilPictureRef = FirebaseStorage.getInstance().getReference().child("Profile pictures");
    ...
    private void update0nlyUserInfo() {
    ...
    private void uploadImage() {
        ...
        if (imageUri != null)
        {
            final StorageReference fileRef = StorageProfilPictureRef.child(Prevalent.currentOnlineUser.getPhone() + ".jpg");
