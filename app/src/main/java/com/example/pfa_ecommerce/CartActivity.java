...
import com.example.pfa_ecommerce.Model.Cart;
import com.example.pfa_ecommerce.Prevalent.Prevalent;
import com.example.pfa_ecommerce.ViewHolder.CartViewHolder;
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Cart, CartViewHolder> adapter = new FirebaseRecyclerAdapter<Cart, CartViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull CartViewHolder holder, int position, @NonNull final Cart cart) {
                ...
                int onTypeProductPrice = ((Integer.valueOf(cart.getPrice()))) * Integer.valueOf(cart.getQuantity());
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    if (shippingState.equals("shipped")) {
                        ...
                        txtMsg.setText("Congratulation, your final order has been shipped successfully. Soon you will receive your order at your door steps.");
